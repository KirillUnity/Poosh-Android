...
public class SectionedGridRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private int mSeparatorResourceId;
    ...
    )
    {
        ...
        mSeparatorResourceId = separatorResourceId;
    ...
    public static class SectionViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public SectionViewHolder(View view, int mTextResourceid, int mButtonResourceid, int mSeparatorResourceid) {
            super(view);
            title = (TextView) view.findViewById(mTextResourceid);
            button = (Button) view.findViewById(mButtonResourceid);
            separator = view.findViewById(mSeparatorResourceid);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int typeView) {
        if (typeView == SECTION_TYPE) {
            ...
            return new SectionViewHolder(view, mTextResourceId, mButtonResourceid, mSeparatorResourceId);
        }
        else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder sectionViewHolder, int position) {
        if (isSectionHeaderPosition(position)) {
            ...
            holder.button.setVisibility(View.GONE); //todo
        }
        else {
